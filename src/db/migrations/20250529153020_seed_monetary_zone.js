...
exports.up = async function(knex) {
  await knex('monetaryZone').insert([
    {
      monetaryZoneId: 'ADP',
    ...
    {
      monetaryZoneId: 'XXX',
      name: 'The codes assigned for transactions where no name is involved'
    },
    {
      monetaryZoneId: 'YDD',
      name: 'Yemeni Dinar'
  ...
  ]).onConflict('monetaryZoneId').merge();
};
...
exports.down = async function(knex) {
  await knex('monetaryZone').delete();
};
